...
const aspectOptions = [
    ...
    { value: "21:9", label: "21:9", width: 2389, height: 1024, icon: "landscape" },
    { value: "9:21", label: "9:21", width: 1024, height: 2389, icon: "portrait" },
];
...
export function ImageSettingsPanel({ config, onConfigChange, theme, showTitle = true, className = "w-[320px] space-y-4 rounded-2xl px-1 py-0.5", maxCount = 500, quickCount = 10 }: ImageSettingsPanelProps) {
...
export function imageResolutionLabel(value: string) {
    return resolutionOptions.find((item) => item.value === value)?.label || value;
}
