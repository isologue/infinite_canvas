...
export const DEFAULT_PROMPT_SOURCES: PromptSource[] = [
    ...
    { id: "tigerowo-gpt-image-2-prompts", name: "Tigerowo GPT Image 2", url: "/prompts/tigerowo-gpt-image-2-prompts.json", homepage: "https://github.com/tigerowo/awesome-gpt-image-2-prompts", enabled: true, builtIn: true },
