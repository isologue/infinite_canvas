...
export default function ImagePage() {
    ...
    const generationCount = Math.max(1, Math.min(500, Number(config.count) || 1));
    ...
    return (
        <>
            ...
            <div className="col-span-2">
                <ImageSettingsPanel config={config} onConfigChange={(key, value) => updateConfig(key, value)} theme={theme} showTitle={false} className="space-y-4" maxCount={500} />
            </div>
        </>
    );
}
